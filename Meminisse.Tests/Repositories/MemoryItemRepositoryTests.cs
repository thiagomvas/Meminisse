...
internal class MemoryItemRepositoryTests : BaseRepositoryTest
{
    ...
    public async Task AddRangeAsync_ShouldAddMemoryItems()
    {
        ...
        {
            new MemoryItem { MemoryId = Guid.NewGuid(), Content = "Content 1", DateAdded = DateTime.Now, Type = MemoryType.Text },
            new MemoryItem { MemoryId = Guid.NewGuid(), Content = "Content 2", DateAdded = DateTime.Now, Type = MemoryType.Image }
        };
